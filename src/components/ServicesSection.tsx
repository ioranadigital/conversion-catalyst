      ...
      <div className="grid md:grid-cols-3 gap-6">
        {services.map((s, i) => (
          <motion.div
            ...
            className="bg-[#ebf2f7]/5 p-8 group transition-all duration-500 flex flex-col rounded-2xl border border-[#ebf2f7]/10 hover:bg-[#0a2b49] hover:border-[#ebf2f7] hover:shadow-[0_0_30px_rgba(255,140,0,0.2)]"    
            >
